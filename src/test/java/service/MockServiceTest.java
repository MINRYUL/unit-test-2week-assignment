...
public class MockServiceTest {
    ...
    @Test
    public void shouldSetMidPositionUesVerify(){
        Champion champion = mock(Champion.class);
        champion.setName("직스");
    ...
    @Test
    public void shouldNeverInvoationWhenChampionSetName() {
        Champion champion = mock(Champion.class);
        champion.setHasSkinCount(3);
...
//        verify(mockRepository, times(1)).findByName(anyString());
    ...
    @Test
    public void shouldPositionisTopFindBynameLissandra() {
    ...
    public void testSkinCountAndInvocationOneTimeWhenFindChampion(){
        when(mockService.findByName(anyString())).thenReturn(new Champion("오른", "탑", 2));
        assertThat(mockService.findByName("르블랑").getHasSkinCount(), is(2));
        verify(mockRepository, times(1)).findByName(anyString());
    }
